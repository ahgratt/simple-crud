...
<?php
	...
	for($i = 1;$i <= 31; $i++){$option_tanggal=$option_tanggal."<option value=$i ".($tanggal[2]==$i?'selected':'').">$i</option>";}

	$bulan=["","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"];
	$option_bulan="<option value='' style='display:none'>- Pilih Bulan -</option>";
	for($i = 1;$i <= 12; $i++){$option_bulan=$option_bulan."<option value=$i ".($tanggal[1]==$i?'selected':'').">$bulan[$i]</option>";}
