...
<?php
	...
	while($h=mysqli_fetch_array($q)){$option_pasien=$option_pasien."<option value=$h[Pasien_ID]>$h[Nama_Pasien]</option>";}

	$option_tanggal="<option value='' style='display:none'>- Pilih Tanggal -</option>";
	for($i = 1;$i <= 31; $i++){$option_tanggal=$option_tanggal."<option value=$i>$i</option>";}

	$bulan=["","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"];
	$option_bulan="<option value='' style='display:none'>- Pilih Bulan -</option>";
	for($i = 1;$i <= 12; $i++){$option_bulan=$option_bulan."<option value=$i>$bulan[$i]</option>";}
	...
	while($h=mysqli_fetch_array($q)){$option_dokter=$option_dokter."<option value=$h[Dokter_ID]>$h[Nama_Dokter]</option>";}
...
<div class="container mt-3">
	...
	<a href='list_berobat.php' class='btn btn-warning'>< Back</a><br><br>
